...
const frames: {
  ...
  { style: "chrome-light", tone: "mono", rotate: -9, translate: "-14% 6%", z: 10, width: "82%" },
  { style: "safari-dark", tone: "slate", rotate: -3, translate: "-2% 0%", z: 20, width: "88%" },
  { style: "chrome-dark", tone: "amber", rotate: 4, translate: "6% -2%", z: 30, width: "92%" },
  { style: "safari-light", tone: "amber", rotate: 10, translate: "16% 4%", z: 15, width: "80%" },
];
        ...
        {frames.map((f, i) => {
          ...
          return (
            ...
            >
              <BrowserFrame
                style={f.style}
                url={i === 2 ? "your-product.com" : "framely.app"}
